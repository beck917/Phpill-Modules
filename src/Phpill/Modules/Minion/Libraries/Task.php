...
abstract class Task {
	 ...
	 * @throws \Phpill\Modules\Minion\Libraries\Exception\InvalidTask
	 * @return Minion_Task The Minion task
	 */
	public static function factory($options)
	{
		if (($task = \Phpill\Libraries\Arr::get($options, 'task')) !== NULL)
		{
			unset($options['task']);
		}
		...
		{
			throw new \Phpill\Modules\Minion\Libraries\Exception\InvalidTask(
	...
	protected function _help(array $params)
	{
		...
		$view = \Phpill\Libraries\View::factory('minion/help/task')
